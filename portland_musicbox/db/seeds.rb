...
labels = ['Kill Rock Stars', 'Tender Loving Empire', 'Good Cheer', 'Golden Brown', 'Virgin', 'Dischord', 'GOOD Music', 'Geographic North']
founded = [1991, 2005, 2014, 2016, 1972, 2004, 2007]
