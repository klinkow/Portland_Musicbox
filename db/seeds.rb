...
album_id.tags.create(text: "Rock")
...
album_id.tags.create(text: "Indie Rock")
album_id.tags.create(text: "Punk")
...
troutmask.tags.create(text: "1969 albums")
troutmask.tags.create(text: "Outsider music")
troutmask.tags.create(text: "Protopunk albums")
troutmask.tags.create(text: "Straight Records albums")
troutmask.tags.create(text: "English-language albums")
