...
author = Author.create(name: "Andy Kellman")
Review.create(album_id: album_id.id, author_id: author.id, text: "Scary -- 'Closed Captioned' through 'Foreman's Dog' provides the worst stretch of material Fugazi have recorded, full of disjointed patches and awkward moments.")
Tag.create(text: "Indie Rock")
Tag.create(text: "Punk")
...
Tag.create(text: "Outsider music")
Tag.create(text: "Protopunk albums")
Tag.create(text: "1969 albums")
Tag.create(text: "Straight Records albums")
Tag.create(text: "English-language albums")
